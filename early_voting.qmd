...
```{r}
md_early_voting <- read_csv("https://elections.maryland.gov/press_room/2024_stats/PG24/EarlyVoting%20RAW%20data.csv") %>% filter(AgeGroup == '65 and older')
...
md_early_voting_county_gender %>%
  ...
  labs(
    title="Women Lead 65 and older Maryland Early Voters",
    y = "percent female",
    x = "percent male",
